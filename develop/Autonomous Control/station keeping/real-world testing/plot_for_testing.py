...
import math
import threading
from sailboat_for_testing import sailboat
import random
...
class visualazation():
    def __init__(self):
        ...
        self.boat_size=self.my_boat.boat_size
    ...
    def plot(self):
        ...
        ani = animation.FuncAnimation(
            self.figure, self.animate1, init_func=self.init1, interval=10, blit=True, save_count=30)
